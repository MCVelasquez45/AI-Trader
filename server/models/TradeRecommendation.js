...
const tradeRecommendationSchema = new mongoose.Schema({                                                                              
  ...
  userIdentifier: {
    type: String,
    required: true, // 🔐 Used to associate trades with users (email, ID, or guest token)
...
export default mongoose.models.TradeRecommendation || mongoose.model('TradeRecommendation', tradeRecommendationSchema);